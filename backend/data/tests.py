...
class CalculateHba1cTestCase(TestCase):
    def setUp(self):
        ...
        self.pet = Pet.objects.create(
            ...
            sore_spot="관절",
            weight=4,
            started_date=timezone.make_aware(datetime.datetime(2023, 7, 1, 0, 0, 0)),
            user=self.user
        )
        ...
        self.data = Data.objects.create(
            ...
            record_type=0,
            bloodsugar=100,
            created_at=timezone.make_aware(datetime.datetime(2023, 7, 1, 0, 0, 0)),
            updated_at=timezone.make_aware(datetime.datetime(2023, 7, 2, 0, 0, 0))
        )
